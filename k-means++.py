...
y1=[p.y for p in points]
s=[p.group+1 for p in points]
c=[(p.group+1)*30 for p in points]

x2=[cluster_centers[i].x for i in range(7)]
y2=[cluster_centers[i].y for i in range(7)]

fig1=plt.figure(1,figsize=(10,10))
ax1=fig1.add_subplot(111)
ax1.scatter(x1,y1,s,c)
ax1.scatter(x2,y2,s=30,c='r')
plt.show()